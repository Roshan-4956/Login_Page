    ...
    <div className={classes.box1}>
      <div className={classes.box1Wrap_1}>
        <div className={classes.box1_sub}>
          <img src="../images/img1.jpg" alt="" className={classes.img1} />
          <img src="../images/img2.jpg" alt="" className={classes.img2} />
        </div>
        <div className={classes.box2_sub}>
          <img src="../images/img3.jpg" alt="" className={classes.img3} />
        </div>
      </div>
